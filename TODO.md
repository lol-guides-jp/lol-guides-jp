...
次のアクション:
- [ ] 次パッチ（26.8）リリース時に既存ガイドの更新（POLICY.md参照）
- [ ] メタ落ちチャンプへの注釈追加
- [x] パッチ26.7変更チャンピオン更新（10体: Cassiopeia, Kalista, Rell, Graves, Karma, Nami, Ornn, Singed, Veigar, Shyvana）
- [x] ADCマッチアップガイド作成（6体: Jinx, Ashe, Miss Fortune, Ezreal, Kai'Sa, Caitlyn）
